    ...
    <main className="pt-20 lg:pt-24 min-h-screen">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="font-display text-4xl sm:text-5xl lg:text-7xl font-light text-cream leading-tight mb-6 whitespace-nowrap">
            For Paradise Birds Only
          </h1>
          ...
          <p className="font-body text-base font-semibold text-cream leading-relaxed mb-4">
            Это и есть SUVARNA.
          </p>
          <p className="font-body text-sm text-cream-muted leading-relaxed mb-4">
            Имя бренда переводится с санскрита как «золотая». И это не просто слово — это обещание. Каждое изделие отшивается в собственном ателье в Дели, где искусные портные и вышивальщики превращают редчайшие ткани — жаккарды, индийские шелка, полотна ручного ткачества — в одежду, которую нельзя спутать ни с чем.
          </p>
          <p className="font-body text-sm text-cream-muted leading-relaxed mb-12">
            SUVARNA создаёт одежду для женщин особого типа — тех, кого называют райскими птицами. Они не обязательно заметны издалека. Но рядом с ними всегда что-то происходит. Какой-то невероятный случай. Какое-то приключение. Потому что особая одежда умеет менять не только то, как нас видят — но и то, что с нами случается.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div>
            ...
            <p className="font-body text-base text-cream-muted leading-relaxed mb-5">
              Путь Зоры в Индию начался не сразу. Сначала — просто туристическое любопытство. Более 15 лет она работала персональным стилистом, одевая клиенток по всему миру — от Москвы до Милана, от Дубая до Лондона — и пошив гардероба, отточенный на десятках разных культур и вкусов, постепенно привёл её к тканям: сначала европейским, а затем к совершенно особому миру.
            </p>
            <p className="font-body text-base text-cream-muted leading-relaxed mb-5">
              Вместе с партнёром Анной Степановой она открыла текстильный рынок Мумбаи — крупнейший в Азии — и навсегда влюбилась в индийский текстиль: фантастический мир, объединивший тысячелетние традиции с современным мастерством. Так родилась компания A+Fabrics, а затем и бренд SUVARNA.
            </p>
            <p className="font-body text-base text-cream-muted leading-relaxed mb-8">
              Название SUVARNA на санскрите означает «золото», «золотая». Золотая линия одежды для райских птиц — именно так Зора видит своих клиенток: ярких, особенных, живущих насыщенной жизнью.
            </p>
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="max-w-3xl mx-auto text-center">
          <p className="font-body text-sm text-cream-muted leading-relaxed mb-10">
            За дизайнером всегда стоит команда. SUVARNA создаётся Зорой Полковниковой — и сооснователями, которые поверили в эту идею так же сильно, рисковали вместе с ней и не останавливались, пока бренд не родился по-настоящему.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="border-cream border p-6">
              <p className="section-label text-cream-faint mb-2">Дизайнер</p>
              <p className="font-display text-xl font-light text-cream">Зора Полковникова</p>
            </div>
            <div className="border-cream border p-6">
              <p className="section-label text-cream-faint mb-2">Сооснователи</p>
              <p className="font-display text-lg font-light text-cream leading-relaxed">Оксана Кривошеева<br />Анна Степанова<br />Зухаиб Имтияз Дар</p>
            </div>
          </div>
        </div>
      </div>
