        ...
        <div className="space-y-10">
          <section>
            ...
            <div className="space-y-4">
              {[
                { title: 'Курьер (Москва)', price: '600 ₽', time: '1–2 рабочих дня', desc: 'Доставка курьером по Москве. Время доставки согласовывается по телефону.' },
                { title: 'СДЭК', price: '700 ₽', time: '2–5 рабочих дней', desc: 'Доставка в пункты выдачи СДЭК по всей России. Трек-номер предоставляется после отправки.' },
                { title: 'Почта России', price: '500 ₽', time: '5–10 рабочих дней', desc: 'Доставка Почтой России. Подходит для отдалённых регионов.' },
