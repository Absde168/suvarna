...
export default function ProductDetail() {
  ...
  const accordionItems = [
    ...
    },
    {
      ...
      content: 'Доставка по всей России: СДЭК, Почта России, курьер (Москва). Срок доставки: 2–7 рабочих дней. Возврат в течение 14 дней с момента получения при сохранении товарного вида.',
    },
  ];
